...
enum EnumCronometro {
  CRONOMETRO_RESETAR,//Restaura tempo original e passa para o estado de iniciar

  CRONOMETRO_INICIAR,//Inicio do cronometro

  CRONOMETRO_PAUSAR,//Pausa cronometro

  CRONOMETRO_CONTINUAR,//continua contagem do cronometro

  CRONOMETRO_EXECUTAR,//Cronometro em execução

  CRONOMETRO_TERMINAR//Cronometro finalizado
