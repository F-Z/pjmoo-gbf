...
void GraphicSystemScreen::destravar() 
{
    if (SDL_MUSTLOCK(pScreen)) {
...
void GraphicSystemScreen::setScreen(SDL_Surface * surface) 
{
    pScreen = surface;
}
