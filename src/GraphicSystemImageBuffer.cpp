...
//Construtor
GraphicSystemImageBuffer::GraphicSystemImageBuffer() 
{
...
bool GraphicSystemImageBuffer::carregarArquivo(std::string arquivo) 
{
...
void GraphicSystemImageBuffer::desenhar(Ponto POSICAO) 
{
    SDL_Rect rect,pos;
...
void GraphicSystemImageBuffer::desenhar(SDL_Rect POSICAO, SDL_Rect TAMANHO, int FRAME) 
{
    SDL_Rect rect;
...
void GraphicSystemImageBuffer::desenhar(SDL_Rect POSICAO, SDL_Rect TAMANHO, int FRAME, SDL_Rect CORTE) 
{
    SDL_Rect rect;
